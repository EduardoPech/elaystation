        ...
        <div class="mr-auto lg:col-span-12">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div className="mt-3">
              ...
              <a href="/register" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-500	hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">
                Empezar ahora
